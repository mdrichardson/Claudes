(function (root, factory) {
  ...
  // Anchor on any SGR escape within 40 bytes of the literal "plan mode on" so
  // we don't match unstyled "plan mode on" appearing in conversation text.
  var PLAN_MODE_BANNER = /\x1b\[[\d;]*m[^\x1b]{0,40}?plan mode on/i;
